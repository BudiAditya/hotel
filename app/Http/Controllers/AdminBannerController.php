<?php namespace App\Http\Controllers;
	...
	class AdminBannerController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->form[] = ['label'=>'Link','name'=>'link','type'=>'text','validation'=>'required','width'=>'col-sm-10','placeholder'=>'Please enter a valid URL'];
			$this->form[] = ['label'=>'Button Text','name'=>'button_text','type'=>'text','validation'=>'required','width'=>'col-sm-10'];
