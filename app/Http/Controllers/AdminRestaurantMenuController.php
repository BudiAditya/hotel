<?php namespace App\Http\Controllers;
	...
	class AdminRestaurantMenuController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->form = [];
			$this->form[] = ['label'=>'Category','name'=>'category','type'=>'select','validation'=>'required|min:1|max:255','width'=>'col-sm-10','dataenum'=>'Breakfast;Lunch;Dinner'];
